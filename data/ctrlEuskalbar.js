...
document.getElementsByTagName("HEAD")[0].appendChild(css)
	...
	var preferences = data.ctrlPreferences;
	...
	var hiztegiakArrayCTRL = Object.getOwnPropertyNames(preferences);
	hiztegiakArrayCTRL.forEach( function(hiztegictrlEuskalbar) {
		var dictName = hiztegictrlEuskalbar.substr(0,hiztegictrlEuskalbar.length-11);
